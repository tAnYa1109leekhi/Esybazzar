...
setItem(updateitem);
  ...
  <div className='course-shape one'><img  src='/images/shape-img/icon/01.png'  alt='image'/></div>
  <div className='course-shape two'><img  src='/images/shape-img/icon/02.png'  alt='image'/></div>
{/*main section */}
